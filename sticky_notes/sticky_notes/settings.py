...
SECRET_KEY = 'django-insecure-ev9+@_2s9=fkhjt81@y)9b5r2b-^z2twm505tj%d_f(9+(dyot'
...
STATICFILES_DIRS = [
	# Define the directory where app-specific static files are located
